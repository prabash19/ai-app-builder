...
export default function LandingPage() {
  ...
  return (
    <div
      className="
      w-full h-screen bg-gradient-to-br from-purple-600 via-blue-500 to-purple-500 text-white
    ...
    >
      ...
      <h2 className="font-bold mb-8 text-xl  text-gray-300 leading-tight">
      ...
      <div className="relative w-1/2">
        <textarea
          ...
          placeholder="Build Apps by chatting with AI."
